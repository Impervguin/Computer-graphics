...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.DelayOnButton.setGeometry(QtCore.QRect(20, 40, 121, 25))
        self.DelayOnButton.setObjectName("DelayOnButton")
        self.DelayOffButton = QtWidgets.QRadioButton(self.FillGroupBox)
        self.DelayOffButton.setGeometry(QtCore.QRect(230, 40, 131, 25))
        ...
        self.AddButton.setGeometry(QtCore.QRect(30, 710, 141, 41))
        self.AddButton.setObjectName("AddButton")
        self.CloseFigureButton = QtWidgets.QPushButton(self.ManagementGroupBox)
        self.CloseFigureButton.setGeometry(QtCore.QRect(220, 710, 141, 41))
        self.CloseFigureButton.setObjectName("CloseFigureButton")
        self.label_6 = QtWidgets.QLabel(self.ManagementGroupBox)
        self.label_6.setGeometry(QtCore.QRect(30, 940, 321, 51))
        self.label_6.setObjectName("label_6")
        self.ClearScreenButton = QtWidgets.QPushButton(self.ManagementGroupBox)
        self.ClearScreenButton.setGeometry(QtCore.QRect(30, 820, 331, 31))
        ...
        self.FillPolygonButton.setGeometry(QtCore.QRect(30, 870, 331, 31))
...
" ЛКМ - поставить точку\n"
"ПКМ - Замкнуть фигуру"))
        self.ClearScreenButton.setText(_translate("MainWindow", "Очистить экран"))
