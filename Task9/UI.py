...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CloseCuttingButton = QtWidgets.QPushButton(self.ManagementGroupBox)
        self.CloseCuttingButton.setGeometry(QtCore.QRect(30, 940, 330, 41))
        self.CloseCuttingButton.setObjectName("CloseCuttingButton")
...
" ПКМ - поставить точку отсекателя"))
        ...
        self.CloseCuttingButton.setText(_translate("MainWindow", "Замкнуть отсекаемый"))
